...
public sealed record OpinionEnum : Enumeration<OpinionEnum>, IStixEnum
{
    ...
    /// <summary>
    /// Returns an <see cref="OpinionEnum"/> from the equivalent numeric representation, from 1 (<see cref="StronglyDisagree"/>) to 5 (<see cref="StronglyAgree"/>).
    /// </summary>
    ...
    /// <exception cref="ArgumentOutOfRangeException"><param name="value"></param> was outside the bounds of 1-5 (inclusive).</exception>
