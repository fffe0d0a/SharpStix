...
public record
    MitreCollection : StixObject //Mitre objects implemented using the documentation at https://github.com/mitre/cti/blob/master/USAGE.md
{
    ...
    public required MitreAttackSpecVersion AttackSpecVersion { get; init; }
